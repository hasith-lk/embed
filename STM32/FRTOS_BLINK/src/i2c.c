...
/*
Status beginTransmission(I2C_TypeDef* I2Cx, uint8_t SlaveAddress)
{
   __IO uint32_t Timeout = 0;
...
Status endTransmission(I2C_TypeDef* I2Cx)
{
   __IO uint32_t Timeout = 0;
   // Check the following flag from stm32f10x_i2c.h file
...
void i2cwrite(uint8_t i2cioSlaveAddr, uint8_t data)
{
